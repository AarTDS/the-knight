...
if(global.sword_thrown == 0)
{
	...
	if(sword_arm == 1)
	{
		...
		var l7C74A161_0;
		l7C74A161_0 = keyboard_check(ord("W"));
		if (l7C74A161_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		var l167C87B2_0;
		l167C87B2_0 = keyboard_check(ord("S"));
		if (l167C87B2_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		var l13AA3672_0;
		l13AA3672_0 = keyboard_check(ord("A"));
		if (l13AA3672_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		var l0F4BD40B_0;
		l0F4BD40B_0 = keyboard_check(ord("D"));
		if (l0F4BD40B_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("S")"
		var l22B0066F_0;
		l22B0066F_0 = keyboard_check_released(ord("S"));
		if (l22B0066F_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("W")"
		var l07E246E9_0;
		l07E246E9_0 = keyboard_check_released(ord("W"));
		if (l07E246E9_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("A")"
		var l77860ABC_0;
		l77860ABC_0 = keyboard_check_released(ord("A"));
		if (l77860ABC_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("D")"
		var l1C30736E_0;
		l1C30736E_0 = keyboard_check_released(ord("D"));
		if (l1C30736E_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
	...
	if(sword_arm == 0)
	{
		...
		/// @DnDArgument : "key" "ord("W")"
		var l1B68F450_0;
		l1B68F450_0 = keyboard_check(ord("W"));
		if (l1B68F450_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("S")"
		var l48E40533_0;
		l48E40533_0 = keyboard_check(ord("S"));
		if (l48E40533_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("A")"
		var l162A5F6D_0;
		l162A5F6D_0 = keyboard_check(ord("A"));
		if (l162A5F6D_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("D")"
		var l0A7326ED_0;
		l0A7326ED_0 = keyboard_check(ord("D"));
		if (l0A7326ED_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("S")"
		var l4C7BE000_0;
		l4C7BE000_0 = keyboard_check_released(ord("S"));
		if (l4C7BE000_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("W")"
		var l5E9579FC_0;
		l5E9579FC_0 = keyboard_check_released(ord("W"));
		if (l5E9579FC_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("A")"
		var l1E90F0B1_0;
		l1E90F0B1_0 = keyboard_check_released(ord("A"));
		if (l1E90F0B1_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "key" "ord("D")"
		var l64A717B1_0;
		l64A717B1_0 = keyboard_check_released(ord("D"));
		if (l64A717B1_0)
		{
			/// @DnDAction : YoYo Games.Common.Variable
			/// @DnDVersion : 1
